      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-1">
          {t.items.slice(0, 3).map((item, idx) => {
            ...
            const imageUrl = serviceImages[idx] || item.image || "/placeholder.jpg"
            ...
            return (
              ...
              >
                <Link href="/services" className="group block h-full">
                  <div className="relative h-[500px] w-full overflow-hidden bg-secondary">
                    {/* Background Image */}
                    <Image
                      src={imageUrl}
                      alt={item.title}
        ...
        <div className="mt-16 text-center">
          <Link href="/services">
            <Button
              variant="outline"
              className="border-2 border-primary text-primary hover:bg-primary hover:text-white bg-transparent px-8 py-6 text-sm font-bold uppercase tracking-wider"
            >
