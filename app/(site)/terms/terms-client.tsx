          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <h3 className="text-xl font-semibold">{t.sections.acceptance.title}</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold">{t.sections.use.title}</h3>
                <div className="whitespace-pre-line text-muted-foreground leading-relaxed">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold">{t.sections.services.title}</h3>
                <div className="whitespace-pre-line text-muted-foreground leading-relaxed">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold">{t.sections.intellectual.title}</h3>
                <div className="whitespace-pre-line text-muted-foreground leading-relaxed">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold">{t.sections.liability.title}</h3>
                <div className="whitespace-pre-line text-muted-foreground leading-relaxed">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold">{t.sections.jurisdiction.title}</h3>
                <div className="whitespace-pre-line text-muted-foreground leading-relaxed">
